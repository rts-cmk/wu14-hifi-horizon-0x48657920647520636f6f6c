export default function About(){
    ...
    return(
        <>
            <h1 className="main__title">OUR HISTORY</h1>
            <section className="about">
                <img className="about__picture" src="history.jpg" alt="History" />
                <article className="info">
                    <h2 className="info__title">History</h2>
                ...
                <img className="about__picture" src="hear_the_difference.jpg" alt="Hear The Difference" />
                <article className="info">
                    <h2 className="info__title">Hear The Difference</h2>
                    <p className="info__text info__text--highlight">
                ...
                <img className="about__picture" src="services.jpg" alt="Services" />
                <article className="info">
                    <h2 className="info__title">Services</h2>
                    <p className="info__text info__text--highlight">
                ...
                <img className="about__picture" src="tailored_for_you.png" alt="Tailored For You" />
                <article className="info">
                    <h2 className="info__title">Tailored For You</h2>
                    <p className="info__text info__text--highlight">
